...
function TaskList() {
  ...
  return (
    <div className='flex justify-center'>
       ...
       <div  style={{height:'179px', borderRadius:" 0 0 16px 16px",backgroundColor:"white"}}>
          <Box sx={{display:"flex", alignItems:"center", height:"55.68px"}}>
            <ArrowBackIosNewIcon sx={{mr:2}}/>
            <Typography>New Customer</Typography>
          </Box>
          <hr></hr>
          <Box sx={ {display:"flex",alignItems:'center', justifyContent:"space-around", mt:"15px", height:"100px",p:2}}>  
               <div style={{alignContent:"start"}}>
                  <img alt='customer_image' width="80px" height="80px" src={profileImage}/>
               </div>
               <div>
                  <Typography> <b>Sourav Kumar</b> <span>(Borrower)</span></Typography> 
        ...
        {tasklistSteppers.map((el,index)=><>
           <Grid item xs={12} sx={{  }}>
              <Item sx={{  display:"flex", alignItems:'center',height:"64px",justifyContent:"space-between",borderRadius:'15px'}}>
                     <div style={{}}>
                     <div style={{width:"50px",height:"50px",backgroundColor:"#D2D5DB", borderRadius:'50%'}}/>
                     ...
                     <div className='flex '>
                        {  el?.status =="Completed"?<img src={markedIcon} alt='Completed' className='pr-3'/>:<img src={warningStateIcon} alt='pending' className='pr-3'/> }
                        <KeyboardArrowRightIcon/>
                     </div>
              </Item>
